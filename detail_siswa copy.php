            ...
            <div class="border-tagih">
                ...
                <div class="isi-tagih">
                                        ...
                                        <td>
                                            ...
                                            if (@$_SESSION['level_user'] == 'admin' || @$_SESSION['level_user'] == 'petugas') {
                                                if (!$cek_bulan > 0) {
                                                    if (!$nis_global == 0) {
                                            ?>
                                                        <a class="btn-bayar" href="../tambah/tambah_pembayaran_spp.php?bulan=<?= $bulan ?>&nis=<?= $row['nis'] ?>&tahun=<?= $thn_bayar ?>&page=pembayaran">BAYAR</a>
                    ...
                    <form style="text-align: center;" action="" method="POST">
                        <input type="submit" name="" value="Sebelumnya">
